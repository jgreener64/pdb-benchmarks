...
# MIToS
run_benchmark $nb "julia4 MIToS/parse.jl pdbs/1CRN.pdb"            "MIToS/parse_1CRN.dat"        "MIToS,parse 1CRN,"
run_benchmark $nb "julia4 MIToS/parse.jl pdbs/3JYV.pdb"            "MIToS/parse_3JYV.dat"        "MIToS,parse 3JYV,"
run_benchmark $ns "julia4 MIToS/parse.jl pdbs/1HTQ.pdb"            "MIToS/parse_1HTQ.dat"        "MIToS,parse 1HTQ,"
run_benchmark $nb "julia4 MIToS/count.jl"                          "MIToS/count.dat"             "MIToS,count,"
run_benchmark $nb "julia4 MIToS/distance.jl"                       "MIToS/distance.dat"          "MIToS,distance,"
